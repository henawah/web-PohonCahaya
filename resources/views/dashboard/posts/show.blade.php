...
<div class="container">
    <div class="row my-3">
        <div class="col-lg-8">
            ...
            <a href="/dashboard/posts" class="btn btn-success"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-left-square" viewBox="0 0 16 16">
